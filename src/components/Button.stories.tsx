...
All buttons are built with proper ARIA attributes and focus management for keyboard navigation.
  ...
  argTypes: {
    ...
    loading: {
      control: { type: 'boolean' },
      description: 'Shows a loading spinner within the button',
      table: {
        defaultValue: { summary: 'false' }
      }
    },
...
// Add new story for common use cases
    ...
    <div className="flex flex-col gap-6 max-w-md">
      ...
      <div className="space-y-3">
        ...
        <div className="flex gap-3">
          <Button 
            variant="primary" 
            leftIcon={<svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clipRule="evenodd" /></svg>}
          >
            Add Item
          </Button>
          <Button 
            variant="outline" 
            rightIcon={<svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" /></svg>}
          >
            View Details
          </Button>
        </div>
...
// Website footer button examples
export const WebsiteFooterButtons: Story = {
  args: {
    size: 'md',
    children: 'Button'
  },
  render: () => (
    <div className="max-w-4xl bg-gray-100 dark:bg-gray-800 p-8 rounded-lg">
      <div className="mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="p-4 bg-white dark:bg-gray-900 rounded shadow-sm">
          ...
          <Button 
            ...
            rightIcon={<svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M14.707 12.707a1 1 0 01-1.414 0L10 9.414l-3.293 3.293a1 1 0 01-1.414-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 010 1.414z" clipRule="evenodd" /></svg>}
          >
            Back to Top
          </Button>
        </div>
