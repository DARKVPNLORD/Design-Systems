import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as T}from"./index-D4lIrffr.js";const d=({tabs:t,defaultActiveTab:N,onTabChange:c,className:w="",orientation:m="horizontal"})=>{const[r,j]=T.useState(N||(t.length>0?t[0].id:"")),k=a=>{j(a),c&&c(a)},s=m==="vertical";return e.jsxs("div",{className:`${w} ${s?"flex flex-row":""}`,children:[e.jsx("div",{role:"tablist","aria-orientation":m,className:`
...
}`,...(f=(v=n.parameters)==null?void 0:v.docs)==null?void 0:f.source}}};const D=["Horizontal","Vertical","DarkModePreview"];export{n as DarkModePreview,i as Horizontal,o as Vertical,D as __namedExportsOrder,A as default};
